...
samplegroup
limits nMax=$MAXN kMax=$MAXN qMax=$MAXQ


group group1 9
limits nMax=15 kMax=15 qMax=15
...
group group2 11
limits nMax=100 kMax=100 qMax=100
...
group group3 17
limits nMax=1000 kMax=1000 qMax=1000
...
group group4 5
limits nMax=$MAXN kMax=1 qMax=$MAXQ
...
group group5 7
limits nMax=$MAXN kMax=2 qMax=$MAXQ
...
group group7 23
limits nMax=$MAXN kMax=$MAXN qMax=1
