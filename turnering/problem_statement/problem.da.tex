...
\begin{tabular}{ccc}
  ...
  \includegraphics[width=0.9\textwidth]{img/turnering-img-1.pdf} &
  \includegraphics[width=0.9\textwidth]{img/turnering-img-2.pdf} &
  \includegraphics[width=0.9\textwidth]{img/turnering-img-3.pdf} 
\end{tabular}
\bigskip
